# Django settings for knowhope project.
import os
...
ADMINS = (
     ('Ryan Stiltz', 'stiltz.ryan@gmail.com'),
)
...
SECRET_KEY = '#$v*ol1acc$82+hb=sw%w$7*s20nkdbd6^!i0^+lsin3fe_is='
...
WSGI_APPLICATION = 'knowhope.wsgi.application'
